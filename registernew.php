  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"><nav>
      ...
      <ul class="nav navbar-nav navbar-right">
		...
		<li><a href="registernew.php">Login</a></li>

		<li><a href="registernew.php">Become a member</a></li>
	...
	<div class= "rows">
		...
		<div align="center" >
			...
			<div class="form-group">
				...
				<label for= "exampleInputPhoneNumber">Invitation Code</label>

				<input type = "number" name="invitationcode" class = "form-control" id = "exampleInputPhoneNumber" placeholder ="Invitation code" required>
